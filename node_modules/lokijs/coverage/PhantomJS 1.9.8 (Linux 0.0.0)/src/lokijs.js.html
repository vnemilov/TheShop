...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">68.3% <small>(1280 / 1874)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">61.49% <small>(610 / 992)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">60.54% <small>(178 / 294)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">68.49% <small>(1276 / 1863)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
4516
4517
4518</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (gtHelper(prop1, prop2)) {
        return (desc) ? (-1) : (1);
      }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(root)) {
<span class="cstat-no" title="statement not covered" >          subLen = root.length;</span>
          // iterate all sub-array items to see if any yield hits
<span class="cstat-no" title="statement not covered" >          if ((segmIndex + 1) &lt; segmCount) {</span>
<span class="cstat-no" title="statement not covered" >            subPath = propPath.slice(segmIndex + 1);</span>
<span class="cstat-no" title="statement not covered" >            for (subIndex = 0; subIndex &lt; subLen; subIndex++) {</span>
<span class="cstat-no" title="statement not covered" >              if (dotSubScan(root[subIndex], subPath, fun, value)) {</span>
<span class="cstat-no" title="statement not covered" >                return true;</span>
              }
            }
          } else {
<span class="cstat-no" title="statement not covered" >            for (subIndex = 0; subIndex &lt; subLen; subIndex++) {</span>
<span class="cstat-no" title="statement not covered" >              if (fun(root[subIndex][pathSegment], value)) {</span>
<span class="cstat-no" title="statement not covered" >                return true;</span>
              }
            }
          }
...
&nbsp;
    function containsCheckFn(a) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof a === 'string' || <span class="branch-1 cbranch-no" title="branch not covered" >Array.isArray(a))</span> {
        return function (b) {
          return a.indexOf(b) !== -1;
        };
      } else <span class="cstat-no" title="statement not covered" >if (typeof a === 'object') {</span>
...
<span class="cstat-no" title="statement not covered" >        if (ltHelper(a, b)) {</span>
<span class="cstat-no" title="statement not covered" >          return false;</span>
        }
<span class="cstat-no" title="statement not covered" >        return !gtHelper(a, b);</span>
      },
&nbsp;
      $gt: function (a, b) {
        return gtHelper(a, b);
...
&nbsp;
      $nin: <span class="fstat-no" title="function not covered" >function (a, b) {</span>
<span class="cstat-no" title="statement not covered" >        return b.indexOf(a) === -1;</span>
      },
&nbsp;
...
&nbsp;
        checkFn = containsCheckFn(a) || <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >          return false;</span>
        };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          this.options.adapter = null;</span>
        }
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.fs.writeFile(dbname, dbstring, callback);</span>
    };
&nbsp;
    /**
...
&nbsp;
    ...
    LokiLocalStorageAdapter.prototype.saveDatabase = function saveDatabase(dbname, dbstring, callback) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (localStorageAvailable()) {
...
<span class="cstat-no" title="statement not covered" >            var parseSuccess = false;</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >              self.loadJSON(dbString, options || {});</span>
<span class="cstat-no" title="statement not covered" >              parseSuccess = true;</span>
            } catch (err) {
<span class="cstat-no" title="statement not covered" >              cFun(err);</span>
            }
<span class="cstat-no" title="statement not covered" >            if (parseSuccess) {</span>
<span class="cstat-no" title="statement not covered" >              cFun(null);</span>
<span class="cstat-no" title="statement not covered" >              self.emit('loaded', 'database ' + self.filename + ' loaded');</span>
            }
          } else {
<span class="cstat-no" title="statement not covered" >            if (typeof (dbString) === "object") {</span>
<span class="cstat-no" title="statement not covered" >              self.loadJSONObject(dbString, options || {});</span>
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.persistenceAdapter !== null) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.persistenceAdapter.mode === "reference" &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof this.persistenceAdapter.exportDatabase === "function")</span> {
          // filename may seem redundant but loadDatabase will need to expect this same filename
<span class="cstat-no" title="statement not covered" >          this.persistenceAdapter.exportDatabase(this.filename, this, <span class="fstat-no" title="function not covered" >function exportDatabaseCallback(err) {</span></span>
<span class="cstat-no" title="statement not covered" >            self.autosaveClearFlags();</span>
<span class="cstat-no" title="statement not covered" >            cFun(err);</span>
          });
        }
...
&nbsp;
      ...
      case '$eq':
        ...
        break;
      case '$dteq':
        <span class="missing-if-branch" title="if path not taken" >I</span>if (ltHelper(val, minVal) || gtHelper(val, maxVal)) {
<span class="cstat-no" title="statement not covered" >          return [0, -1];</span>
        }
        break;
      case '$gt':
...
&nbsp;
        ...
        return (this.searchIsChained) ? (<span class="branch-0 cbranch-no" title="branch not covered" >this)</span> : (this.collection.data.slice());
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          property = property.split('.');</span>
<span class="cstat-no" title="statement not covered" >          while (i--) {</span>
<span class="cstat-no" title="statement not covered" >            rowIdx = filter[i];</span>
<span class="cstat-no" title="statement not covered" >            if (dotSubScan(t[rowIdx], property, fun, value)) {</span>
<span class="cstat-no" title="statement not covered" >              result.push(rowIdx);</span>
            }
          }
        } else {
          while (i--) {
...
<span class="cstat-no" title="statement not covered" >            property = property.split('.');</span>
<span class="cstat-no" title="statement not covered" >            while (i--) {</span>
<span class="cstat-no" title="statement not covered" >              if (dotSubScan(t[i], property, fun, value)) {</span>
        ...
        (function (p, data) {
          return function (a, b) {
            ...
            if (objAp !== objBp) {
              ...
              <span class="missing-if-branch" title="else path not taken" >E</span>if (gtHelper(objAp, objBp)) return 1;
            }
            return 0;
          };
        })(property, this.data);
...
&nbsp;
    ...
    Collection.prototype.where = function (fun) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.cloneObjects) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sat Feb 20 2016 12:17:15 GMT+0000 (GMT)</div>
</div>
